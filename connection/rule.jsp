...
<%
   ...
   try{
      ...
      ResultSet rs =stmt.executeQuery("SELECT * FROM `centerlised_table` WHERE id='"+std_id+"';");
       while(rs.next())
       { 
           if(std_id!=null){
               
           
         String id=rs.getString("stud_individual_id");
    ...
    <div class="row" >
          <div class="col-xs-5" id="row1">
               ...
               <div class="col-xs-6" id="row2">
                      ...
                      <p>Time for one question<b>60 seconds</b></p>
                      <p>Mark per question depends on <b>clue</b></p>
                   ...
                   <div >
                    ...
                    <p> All typo should be in lower case</p>
                    <p> Avoid use of white space in answers</p></ul></h1>
                   </div> 
               </div>
             </div>
    </div>
