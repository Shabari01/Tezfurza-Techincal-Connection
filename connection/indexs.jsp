...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-3">
      <img src="images/<%=filename %>" height=30% width=70%>
    
    </div>
    <div class="col-sm-3">
        <img src="images/......" height=30% width=70% id="img1">
      
    </div>
    <div class="col-sm-3">
        <img src="images/......." height=30% width=70% id="img2">
    </div>
	<div class="col-sm-3">
      <img src="images/" height=30% width=70% id="img3">
    </div>
  </div>
  <h4>
