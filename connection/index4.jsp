...
<html>
    ...
    //int a=3;
      ...
      //     out.println("Yes");
        ...
        ResultSet rs =stmt.executeQuery("SELECT * FROM `technical_connetion_questions` where id='"+number+"';");
            while(rs.next())
       { 
...
<input type="hidden" name="s" id="s">
<input type="submit" name="btn" id="di" disabled="yes" class="btn btn-success">Submit</button>
</form>
